...
DATAPREP_VERSION := $(shell cat projects/deces_dataprep/recipes/deces_dataprep.yml projects/deces_dataprep/datasets/deces_index.yml  | sha1sum | awk '{print $1}' | cut -c-8)
